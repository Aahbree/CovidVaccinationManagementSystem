...
<title>Cancelled Apointments<br></title>
<center>
<h2><br> <br><br>List of Cancelled Apointments</h2>
</center>
<center>
<!-- //todo -->
...
display_function2();
  ...
  WHERE status='Cancelled' and ao.providerId = ? order by datee";
  ...
  {
    echo '<p color:red;> <b>'."No Cancelled Apointments".'</p></b>';
